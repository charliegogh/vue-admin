<template>
  <div class="c-basic-form">
    <div
      :class="
        layout.layout === 'inline' ? 'form-inline-container' : 'from-container'
      "
    >
      <a-form-model
        ref="ruleForm"
            ...
            >
              ...
              >
                <a-select-option
                  ...
                  :value="
                    item[
                      (formField.options && formField.options.value) || 'code'
                    ]
                  "
                >
                  {{
                    item[
                      (formField.options && formField.options.label) || "name"
                    ]
                  }}
                </a-select-option>
              </a-select>
