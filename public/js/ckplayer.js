...
!(function() {
  ...
  !(function() {
    ...
    var thisPath = scriptList[scriptList.length - 1].src
  ...
  ckplayer.prototype = {
    ...
    setPoster: function(src) {
      ...
      var dom = posterImg || document.createElement('img')
      dom.src = src || this.vars['poster']
      dom.id = 'posterImg'
    ...
    analysedVideoUrl: function(video, isChange, time) {
      ...
      if (isChange) {
        if (videoType == 'string') {
          this.html5m3u8 = fileExt == '.m3u8'
        } else {
          this.html5m3u8 = fileExt == 'video/m3u8'
        }
    ...
    addVEvent: function() {
      ...
      var eventPlaying = function(event) {
        ...
        if (document.getElementById('posterImg')) { document.getElementById('posterImg').style.display = 'none' }
      }
    ...
    interFace: function() {
      ...
      var observer = new MutationObserver(function() {
        ...
        var cdH = parseInt(thisTemp.css(thisTemp.CD, 'height'))
    ...
    timeProgressDefault: function() {
      ...
      var playBackImg = cssObj['playProgressImg']
      var cssTemp = null
    ...
    promptShow: function(ele, data) {
      ...
      if (ele || data) {
        ...
        var promoptHeight = this.CB['prompt'].offsetHeight
    ...
    prompt: function() {
      ...
      var showPrompt = function(event) {
        ...
        var pW = pcon['pW']
        var pT = pcon['pT']
        var pL = parseInt(thisTemp.css(this, 'left')) - parseInt(pW * 0.5)
        if (pcon['pL'] > 10) {
          pL = pcon['pL']
        }
        if (pL < 0) {
    ...
    getPromptTest: function() {
      ...
      var pT = this.getCoor(this.CB['timeProgressBg'])['y']
      var pL = 0
    ...
    adPauseCoor: function() {
      if (this.css(this.CB['adElement'], 'display') == 'block') {
        ...
        var h = this.CB['adElement'].offsetHeight
        var pw = this.PD.offsetWidth
        var ph = this.PD.offsetHeight
        this.css(this.CB['adElement'], {
          top: (ph - h) * 0.5 + 'px',
    ...
    loadAdvertisements: function() {
      ...
      var height = this.PD.offsetHeight
    ...
    videoRotation: function(n) {
      ...
      var cdH = this.CD.offsetHeight
      var vW = this.V.videoWidth
      var vH = this.V.videoHeight
      if (vW > 0 && vH > 0) {
        if (ys) {
          if (cdW / cdH > vH / vW) {
            nH = cdH
    ...
    getElement: function(element) {
      ...
      return {
        ...
        alpha: !this.isUndefined(this.css(ele, 'opacity'))
          ...
          : 1,
        show: this.css(ele, 'display') != 'none'
      }
    },
